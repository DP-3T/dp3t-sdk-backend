...
public class KeyVault {
    ...
    public static PrivateKey loadPrivateKey(String privatePart, String algorithm) throws PrivateKeyNoSuitableEncodingFoundException {
        PrivateKey key = null;
    ...
    public static PrivateKey loadPrivateKeyFromJavaEncoding(String privatePart, String algorithm) {
        try {
            return KeyFactory.getInstance(algorithm).generatePrivate(new PKCS8EncodedKeySpec(Base64.getDecoder().decode(privatePart)));
    ...
    public static PublicKey loadPublicKey(String publicPart, String algorithm) throws PublicKeyNoSuitableEncodingFoundException {
        PublicKey key = null;
    ...
    public static PublicKey loadPublicKeyFromJavaEncoding(String publicPart, String algorithm) {
        try {
            return KeyFactory.getInstance(algorithm).generatePublic(new X509EncodedKeySpec(Base64.getDecoder().decode(publicPart)));
        } catch (InvalidKeySpecException | NoSuchAlgorithmException e) {
            return null;
        }
    }
